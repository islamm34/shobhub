...
import '../features/home/screens/home_screen.dart' hide SearchScreen;
...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/product-reviews', builder: (context, state) => const ProductReviewsScreen()),
    GoRoute(path: '/best-sellers', builder: (context, state) => const SearchScreen()),
    GoRoute(path: '/new-arrivals', builder: (context, state) => const SearchScreen()),
    GoRoute(
      path: '/category-products',
      builder: (context, state) {
        final category = state.extra as String?;
        return SearchScreen(category: category);
      },
    ),
    ...
    GoRoute(path: '/shipping-address', builder: (context, state) => const ShippingAddressScreen()),
    GoRoute(path: '/add-address', builder: (context, state) => const AddAddressScreen()),
    GoRoute(path: '/delivery-method', builder: (context, state) => const DeliveryMethodScreen()),
    GoRoute(path: '/payment-method', builder: (context, state) => const PaymentMethodScreen()),
    GoRoute(path: '/checkout-summary', builder: (context, state) => const CheckoutSummaryScreen()),
    GoRoute(path: '/order-success', builder: (context, state) => const OrderSuccessScreen()),
    GoRoute(path: '/order-tracking', builder: (context, state) => const OrderTrackingScreen()),
    GoRoute(path: '/edit-profile', builder: (context, state) => const EditProfileScreen()),
    GoRoute(path: '/orders-history', builder: (context, state) => const OrdersHistoryScreen()),
    GoRoute(path: '/order-details', builder: (context, state) => const OrderDetailsScreen()),
    GoRoute(path: '/notifications', builder: (context, state) => const NotificationsScreen()),
    GoRoute(path: '/empty-notifications', builder: (context, state) => const EmptyNotificationsScreen()),
